                                        ...
                                        while ($data_nilai = $sql->fetch_assoc()) { ?>
                                            ...
                                            ?>
                                                <?php if ($kriteria['kriteria_kategori'] == "cost") { ?>
                                                    ...
                                                    ?>
                                                        <td><?= 'MIN(' . $nilai_Min['min'] . ') / ' . $data_nilai['nilai_faktor'] . ' = ' . number_format($nilaiNormalisasi = $nilai_Min['min'] / $data_nilai['nilai_faktor'], 2); ?></td>
                                                    <?php } ?>
                                                ...
                                                <?php } elseif ($kriteria['kriteria_kategori'] == "benefit") { ?>
                                                    ...
                                                    ?>
                                                        <td><?= $data_nilai['nilai_faktor'] . ' / ' . 'MAX(' . $nilai_Max['max'] . ') = '  . number_format($nilaiNormalisasi = $data_nilai['nilai_faktor'] / $nilai_Max['max'], 2); ?></td>
                                                    <?php } ?>
                                                <?php } ?>
                                            <?php } ?>
                                        <?php } ?>
                                            ...
                                            ?>
                                                <?php if ($kriteria['kriteria_kategori'] == "cost") { ?>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><?= number_format($hasil, 2) . ' * ' . $kriteria['kriteria_bobot'] . ' = ' . number_format($min_dikali_kriteria = $hasil * $kriteria['kriteria_bobot'], 2); ?></td>
                                                ...
                                                <?php } elseif ($kriteria['kriteria_kategori'] == "benefit") { ?>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><?= number_format($hasil, 2) . ' * ' . $kriteria['kriteria_bobot'] . ' = ' . number_format($max_dikali_kriteria = $hasil * $kriteria['kriteria_bobot'], 2); ?></td>
                                ...
                                while ($kriteria = $query_kriteria->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        while ($kriteriaBobot_total = $sql_sum->fetch_assoc()) { ?>
                                            <td><?= $kriteria['kriteria_bobot'] . ' / ' . number_format($kriteriaBobot_total['total_kriteria_bobot'], 2) . ' = ' . number_format($kriteria['kriteria_bobot'] / $kriteriaBobot_total['total_kriteria_bobot'], 4) ?></td>
                                        <?php } ?>
                                    <?php } ?>
                            </tbody>
                        </table>
                                            ...
                                            ?>
                                                <?php if ($kriteria['kriteria_kategori'] == "benefit") { ?>
                                                    ...
                                                    while ($kriteriaBobot_total = $sql->fetch_assoc()) { ?>
                                                        ...
                                                        <td><?= $data_faktor['nilai_faktor'] . 'Pangkat(' . number_format($kriteria['kriteria_bobot'] / $kriteriaBobot_total['total_kriteria_bobot'], 4) . ')' . ' = ' . number_format($nilai_vektor, 4); ?></td>
                                                ...
                                                <?php } elseif ($kriteria['kriteria_kategori'] == "cost") { ?>
                                                    ...
                                                    while ($kriteriaBobot_total = $sql->fetch_assoc()) { ?>
                                                        ...
                                                        <td><?= $data_faktor['nilai_faktor'] . 'Pangkat(' . number_format(-1 * ($kriteria['kriteria_bobot'] / $kriteriaBobot_total['total_kriteria_bobot']), 4) . ')' . ' = ' .  number_format($nilai_vektor, 2); ?></td>
                                ...
                                while ($alternatif = $query_alternatif->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        while ($data_faktor = $query_faktor->fetch_assoc()) { ?>
                                            ...
                                            <?php } ?>
                                        <?php } ?>
                                        <td><?= number_format($total_nilai_vektor, 2) . '/' . number_format($jumlah_vektor_total, 2) . ' = ' . number_format($nilai_wp, 2); ?></td>
