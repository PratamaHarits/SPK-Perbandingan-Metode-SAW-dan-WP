                        ...
                        <tbody>
                            ...
                            while ($alternatif = $data->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <?php } ?>
                                    <!-- aksi -->
                                    <td><a href="" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $alternatif['alternatif_kode'] ?>">Ubah</a> <a href="faktorDelete.php?id=<?= $alternatif['alternatif_kode']; ?>" class="btn btn-danger" onclick=" return confirm('Hapus data ini ?')">Hapus</a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
