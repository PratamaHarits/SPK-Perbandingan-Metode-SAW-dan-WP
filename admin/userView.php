                                ...
                                <tbody>
                                    ...
                                    while ($user = $data->fetch_assoc()) { ?>
                                        <tr>
                                            ...
                                            <td><a href="" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $user['user_id'] ?>">Ubah</a> <a href="userDelete.php?id=<?= $user['user_id']; ?>" class="btn btn-danger" onclick=" return confirm('Hapus data ini ?')">Hapus</a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
